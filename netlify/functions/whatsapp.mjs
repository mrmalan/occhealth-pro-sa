 ...
 *   TWILIO_FROM   — Your Twilio WhatsApp number, e.g. +27100001234
...
export async function handler(event) {
  ...
  if (!TWILIO_SID || !TWILIO_TOKEN || !TWILIO_FROM) {
    return {
      statusCode: 503,
      body: JSON.stringify({ error: "WhatsApp not configured. Add TWILIO_SID, TWILIO_TOKEN, TWILIO_FROM to Netlify environment variables." }),
    };
  }
